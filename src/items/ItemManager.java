...
public class ItemManager {
    ...
    public ItemManager(Playing playing){
        ...
        consumables.add(new Consumable(100, 700, BLUE_POTION));
        consumables.add(new Consumable(200, 700, RED_POTION));

        containers.add(new Container(300, 700, BARREL));
        containers.add(new Container(400, 700, BOX));
