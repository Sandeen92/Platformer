...
public class EnemyManager {
    ...
    private void drawCrabs(Graphics g, int levelOffset) {
        for(Crabby c : crabbies){
            g.drawImage(crabbyArr[c.getEnemyState()][c.getAnimationIndex()], (int) c.getHitbox().x - CRABBY_DRAW_OFFSET_X - levelOffset, (int) c.getHitbox().y - CRABBY_DRAW_OFFSET_Y, RAT_WIDTH, RAT_HEIGHT, null );
